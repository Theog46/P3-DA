...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> FAVOURITE_NEIGHBOUR = Arrays.asList(

            );

    public static List<Neighbour> ListFavouriteNeighbours() {
        return new ArrayList<>(FAVOURITE_NEIGHBOUR);
    }
